  ...
  return (
    <li className="rounded-md border border-zinc-200 bg-zinc-50 p-2 dark:border-zinc-700 dark:bg-zinc-800">
      ...
      <input
        ...
        className="mt-0.5 w-full rounded-md border border-zinc-300 px-2 py-1 text-xs text-zinc-800 focus:border-violet-500 focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
      />
      <div className="mt-1 flex gap-1.5">
        <label className="text-[11px] font-medium text-zinc-500 dark:text-zinc-400">
          ...
          <input
            ...
            className="mt-0.5 w-16 rounded-md border border-zinc-300 px-1.5 py-0.5 text-xs text-zinc-800 focus:border-violet-500 focus:outline-none dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
          />
        </label>
        <label className="text-[11px] font-medium text-zinc-500 dark:text-zinc-400">
          Y
